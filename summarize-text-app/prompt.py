def get_system_prompt():
    system_prompt = "You are an office assistant working on analyzing and summarizing the content of a file."
...
def get_user_prompt():
    ...
    user_prompt = (
        ...
        "Take a deep breath and carefully review your response. Make sure to check the JSON formatting and information multiple times to ensure there are no errors. "
